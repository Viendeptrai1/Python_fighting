...
class PhanTichVaDuDoan:
    ...
    def du_doan(self, input_data, normalization_method):
        """
        ...
        X_train_encoded = self.tien_xu_ly.chuan_hoa_du_lieu(X_train, normalization_method)
        input_df_encoded = self.tien_xu_ly.chuan_hoa_du_lieu_moi(input_df, normalization_method)
